...
/*
	...
	q(...);
		...
		@autohelp q("main", "foo", "bar") => [<div id="main">, <span id="foo">, <input id="bar">]

	t( testName, selector, [ "array", "of", "ids" ] );
		Asserts that a select matches the given IDs
		@autohelp t("Check for something", "//[a]", ["foo", "baar"]);

	url( "some/url.php" );
		Add random number to url to stop caching
		@autohelp url("data/test.html") => "data/test.html?10538358428943"
		@autohelp url("data/test.php?foo=bar") => "data/test.php?foo=bar&10538358345554"
*/
...
test("name", function() {
	...
	t( "Name selector non-input", "[name=autohelp]", ["name-is-autohelp"] );
